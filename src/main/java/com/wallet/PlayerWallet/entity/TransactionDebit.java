...
/**
 * The Class TransactionDebit.
 */
@Entity
@Table(name = "TRANSACTION_DEBIT")
public class TransactionDebit extends AbstractEntity<TransactionId> {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2389812429892082023L;
